    ...
    return (
        ...
        <div className=" flex items-center justify-center">
                ...
                <motion.div
                    ...
                    className="shadow-2xl border-neutral-700 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-5/6 w-5/6 backdrop-blur-2xl bg-neutral-900/95 transition-all duration-500 inset-0 drop-shadow-2xl rounded-2xl">
                    ...
                    <div className="flex justify-evenly absolute right-0 bottom-5 space-x-40 mr-10">
                        <div
                            className=" border-2 border-dashed border-opacity-10 border-white rounded-md hover:border-opacity-0 transition-all duration-500">
                            <motion.div
                                whileHover={{scale: 1.2}}
                                whileTap={{scale: 0.9}}
                            >
